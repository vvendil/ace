...
<a href="#"><i class="fas fa-pen stroke-transparent"></i></a>
           ...
           <hr width="100%">
            ...
            <p id="year-graduation">Expected Year of Graduation<br><strong>2030</strong></p>
            <p id="education">Education<br><strong>Bachelor of Science Information Technology <br><br> Bachelor of Science Information System</strong></p>
    
            <p id="telephone">Telephone<br><strong>09051641182</strong></p>
            <p id="fax">Facebook<br><strong>@ACE</strong></p>
        </div>
        <div id="info-cards">
            ...
            <div class="card">
                ...
                <ul>
                    <li><p class="tags">Company TECH<br><span>MANILA | <span>2019</span></span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a></li>
                    <li><p class="tags">Tch Mahindra<br><span>Manila, PH | <span>2022</span></span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a></li>
            ...
            <div class="card">
                ...
                <ul>
                    <li><p class="tags">Holy Cross College<br><span>Bachelor of Science Information Technology | <span>June 2030</span></span></p>
                        <a class="edit" href="#"><i class="fas fa-pen stroke-transparent-blue"></i></a></li>
